...
final class ProviderRecommendationTests: XCTestCase {
    ...
    func testTheDefaultForNewInstallsIsRecommended() {
        ...
        XCTAssertEqual(ProviderKind.defaultForNewInstalls.defaultModel, "gemini-3.6-flash")
    }
    ...
    func testTheUngroundedWordingNeverClaimsTheScreen() throws {
        ...
        XCTAssertTrue(grounded.contains("41 of 47 near-miss goldens"))
        XCTAssertTrue(grounded.contains("never truncated a long recording"))
    }
}
